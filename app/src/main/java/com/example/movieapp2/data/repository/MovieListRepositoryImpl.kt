...
import com.example.movieapp2.data.local.movie.MovieDatabase
import com.example.movieapp2.data.mappers.toMovie
import com.example.movieapp2.data.mappers.toMovieEntity
import com.example.movieapp2.data.remote.MovieApi
...
class MovieListRepositoryImpl @Inject constructor(
    ...
    override suspend fun getMovieList(
        ...
        return flow {
            ...
            movieDatabase.movieDAO.upsertMovie(movieEntities)
            emit(Resource.Success(
